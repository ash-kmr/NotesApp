...
public class foldernoteAdapter extends ArrayAdapter<notes> {

    public foldernoteAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<notes> objects) {
